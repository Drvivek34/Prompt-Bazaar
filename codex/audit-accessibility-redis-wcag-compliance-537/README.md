# Codex Audit accessibility for Redis (Wcag Compliance Focus)

A developer-focused prompt designed for Codex to audit accessibility Redis applications with a focus on wcag compliance.

> Part of **[Prompt Bazaar](../../README.md)** · [Mega AI Bazaar](https://drvivek34.github.io/Mega-AI-Bazaar/)

## Details
- **Target Tool / Agent**: `Codex`
- **Source URL**: https://github.com/Drvivek34/Prompt-Bazaar/tree/main/codex/audit-accessibility-redis-wcag-compliance-537
