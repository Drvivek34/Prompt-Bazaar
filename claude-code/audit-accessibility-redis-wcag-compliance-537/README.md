# Claude Code Audit accessibility for Redis (Wcag Compliance Focus)

A developer-focused prompt designed for Claude Code to audit accessibility Redis applications with a focus on wcag compliance.

> Part of **[Prompt Bazaar](../../README.md)** · [Mega AI Bazaar](https://drvivek34.github.io/Mega-AI-Bazaar/)

## Details
- **Target Tool / Agent**: `Claude Code`
- **Source URL**: https://github.com/Drvivek34/Prompt-Bazaar/tree/main/claude-code/audit-accessibility-redis-wcag-compliance-537
