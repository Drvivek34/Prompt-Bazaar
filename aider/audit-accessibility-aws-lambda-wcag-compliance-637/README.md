# Aider Audit accessibility for AWS Lambda (Wcag Compliance Focus)

A developer-focused prompt designed for Aider to audit accessibility AWS Lambda applications with a focus on wcag compliance.

> Part of **[Prompt Bazaar](../../README.md)** · [Mega AI Bazaar](https://drvivek34.github.io/Mega-AI-Bazaar/)

## Details
- **Target Tool / Agent**: `Aider`
- **Source URL**: https://github.com/Drvivek34/Prompt-Bazaar/tree/main/aider/audit-accessibility-aws-lambda-wcag-compliance-637
